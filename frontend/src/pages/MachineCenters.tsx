...
export default function MachineCenters(){
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl font-semibold mb-4">{t('machine_centers') || 'Centro Máquina'}</h1>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {t('machine_centers_message') || 'Este módulo requer licenciamento adicional. Entre em contato com o administrador do sistema.'}
            </p>
          </div>
        </div>
      </div>
