...
import { listOrders, createOrder, type Line, orderPdfUrl, sendOrderEmail, getOrder } from '@/api/sales'
...
export default function SalesOrders(){
  ...
  const [hdr, setHdr] = React.useState({ number:'', date:'', client:'', client_name:'', currency:'EUR' })
  ...
  setHdr({ number:'', date:'', client:'', client_name:'', currency:'EUR' }); setLines([{ description:'', qty:1, price:0 }]); reload()
  }
            ...
            <td className="text-right flex gap-2 justify-end px-2 py-1">
              ...
              <button className="px-2 py-1 rounded border" onClick={async()=>{
                ...
                try {
                  ...
                  setEmailing({ id:o.id, to:'', cc:'', bcc:'', suggestedTo: suggested })
